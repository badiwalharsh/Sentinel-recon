...
import { RealtimeProvider, RealtimeStatusIndicator } from '@/components/shared/RealtimeProvider';
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const adminChannels = ['global', `user:${user.userId}`, 'admin:users', 'admin:audit'];
